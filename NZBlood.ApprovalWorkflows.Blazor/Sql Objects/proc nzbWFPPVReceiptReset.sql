...
/****** Object:  StoredProcedure [dbo].[nzbWFPPVReceiptReset]    Script Date: 09-May-26 11:37:59 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE proc [dbo].[nzbWFPPVReceiptReset] @receiptNumber char(17),@comment varchar(max),@userId varchar(100),@isManager int,@isAdmin int
as
declare 
	@batchId char(15) = 'RESET',
	@chk int
...
if @chk=0 begin
	execute taCreateUpdateBatchHeaderRcd
		@I_vBACHNUMB=@batchId,
		@I_vBCHCOMNT='Approval Workflow Reset',
		@I_vSERIES=4,
...
/* update history
*/
insert into nzbWFPPVInvoiceHistory select @receiptNumber,@userId,getdate(),9,@comment,@isManager,@isAdmin
